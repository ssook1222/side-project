            ...
            <div>
                ...
                <div style={{width:"1800px", paddingLeft:"20px"}}>
                    <Row style={{
                        ...
                        <Col className="titles" style={{paddingRight:"25px"}}>강의시간</Col>
                        <Col className="titles" style={{paddingRight:"-10px"}}>교수</Col>
                        <Col className="titles">이수단계</Col>
                        <Col className="titles" style={{paddingRight:"30px"}}>학점/이론/실습</Col>
            ...
            <div style={{width:"1800px", paddingLeft:"20px"}}>
            {
                table.map((table: Table)=>
                    <Row style={{
                        ...
                        <Col className="contents" style={{paddingRight:"15px"}}>{table.plan}</Col>
                        <Col className="contents" style={{paddingRight:"10px"}}>{table.movie}</Col>
                        <Col className="contents">{table.classType}</Col>
                        <Col className="contents">{table.lectureTime}</Col>
                        <Col className="contents" style={{paddingRight:"25px"}}>{table.professor}</Col>
