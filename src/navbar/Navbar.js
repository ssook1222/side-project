...
class Navbars extends React.Component {
    render() {
        return(
            <div>
                <Navbar id="navbar" className="background" style={{marginBottom:"20px"}} expand="xxl">
                    <Container style={{width:"100%"}}>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav" style={{width:"100%"}}>
                            <Nav className="ms-auto justify-content-end">
                                ...
                                <Nav.Link style={{color:"white", marginRight:"10px",fontSize:"20px"}} href="/ready/1">수강신청 연습</Nav.Link>
